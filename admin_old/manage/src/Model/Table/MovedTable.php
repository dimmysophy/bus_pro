...
class MovedTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('OldRoutes', [
            'foreignKey' => 'old_route_id',
            'joinType' => 'INNER'
        ]);
        $this->belongsTo('NewRoutes', [
            'foreignKey' => 'new_route_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['old_route_id'], 'OldRoutes'));
        $rules->add($rules->existsIn(['new_route_id'], 'NewRoutes'));
