...
class BookingDetailsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('BoardingPoints', [
            'foreignKey' => 'boarding_point_id',
            'joinType' => 'INNER'
        ]);
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['rout_id'], 'Routs'));
        $rules->add($rules->existsIn(['boarding_point_id'], 'BoardingPoints'));
