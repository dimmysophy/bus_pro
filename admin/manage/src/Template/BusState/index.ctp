    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= ($busState->bus->name) ?></td>
                <td><?= $busState->has('terminal') ? $this->Html->link($busState->terminal->name, ['controller' => 'Terminals', 'action' => 'view', $busState->terminal->id]) : '' ?></td>
                <td><?= h($busState->take_off_time) ?></td>
                <td><?= h($busState->arrival_time) ?></td>
                <td><?= $busState->has('terminal') ? $this->Html->link($busState->terminal->destination_terminal_name, ['controller' => 'Terminals', 'action' => 'view', $busState->destination_terminal_id]) : $busState->destination_terminal_name ?></td>
