...
<div class="requests view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Serviced') ?></th>
            <td><?= h($request->serviced) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <th scope="row"><?= __('Requesting Terminal') ?></th>
            <td><?= $this->Number->format($request->requesting_terminal) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Terminal From') ?></th>
            <td><?= $this->Number->format($request->terminal_from) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Number Needed') ?></th>
            <td><?= $this->Number->format($request->number_needed) ?></td>
        </tr>
        <tr>
