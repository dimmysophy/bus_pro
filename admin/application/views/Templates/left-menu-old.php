          ...
          <!-- sidebar menu: : style can be found in sidebar.less -->
             <ul class="sidebar-menu">
				   ...
				   <li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/terminals"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/terminals/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
...
<?php
					...
					<li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/agent-terminal"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/agent-terminal/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
				   ...
				   <li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/bus-count"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/bus-count/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
				   ...
				   <li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/bus-state"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/bus-state/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
				   ...
				   <li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/excess"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/ex cess/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
				   ...
				   <li class="treeview">
					  ...
					  <ul class="treeview-menu">
						<li><a href="<?php echo base_url();?>manage/location-graph"><i class="fa fa-circle-o text-aqua"></i>View All</a></li>
						<li><a href="<?php echo base_url();?>manage/location-graph/add"><i class="fa fa-circle-o text-aqua"></i>Add New</a></li>
					  </ul>
                   </li>
             </ul>
        </section>
