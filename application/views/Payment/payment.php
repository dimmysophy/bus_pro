            ...
            <div class="col-md-9">
			   ...
			   <form id="userForm" >
                  ...
                  <div class="rb_nam" ng-repeat="i in counter(numberss) track by $index">
                     ...
                     <div class="rb_name2">   <span class="name_tbb">Age</span> <span class="star_tb">*</span> &nbsp;  &nbsp; <input type="text"   name="age[]" class="rb_age" placeholder="Age"  data-parsley-type="digits"  required></div>
                     <div class="rb_name3" >
            ...
            <div class="col-md-3">
               ...
               <div class="payment_all">
                  ...
                  <div class="payment_sum2">
                     Naira.{{Onewaypaymentdetails[0].fare}} * {{numberss}}
                  </div>
               </div>
             </div>
               <div class="pay_outer">
               <div class="payment_all" style="border-top:1px dotted #bbb;" ng-hide="dateR=='undefined'">
                  ...
                  <div class="offer">
                     Naira.{{Twowaypaymentdetails[0].fare}} * {{numberss}}
                  </div>
               </div>
             </div>
                  <div class="pay_outer">
            ...
            <div class="col-md-11">
               <div class="pay_inner">
                  ...
                  <div class="tab-content current"  id="tab-4" >
                           ...
                           <div class="amount_pay">
                              ...
                              <div class="amount_pay2">
                                 <div class="amount_pay2_tb">
                                    <span class="tb_pay">Amount Payable:</span>  <span class="tb_pay1">Naira.{{totals}}.00</span>
                                 </div>
                                 <br>
                                  <br>
                                 <div class="rupees"> <img src="<?php echo base_url();?>assets/images/inner2.png"><span class="get_off">  GET 20% OFF.<span class="upto">  (Upto Naira.#500) <br>
                    ...
                    <input type='hidden' name='business'  value='agubatachidimma-facilitator@gmail.com'>
 ...
 <div class="tab-content "  id="tab-5" data-id="paytm">
                     ...
                     <div class="tb_route_inner_txt low">
                        <div class="tb_route_inner">
                              ...
                              <div class="amount_pay2">
                                 <div class="amount_pay2_tb">
                                    <span class="tb_pay">Amount Payable:</span>  <span class="tb_pay1">#.{{totals}}.00</span>
                                 </div>
                                 <br>
                                  <br>
                                 <div class="rupees"> <img src="<?php echo base_url();?>assets/images/inner2.png"><span class="get_off">  GET 20% OFF.<span class="upto">  (Upto #.50) <br>
