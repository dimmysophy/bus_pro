            ...
            <div class="row" style="min-height:400px;margin-top:120px;">
			   ...
			   <form id="myForm" method="post" data-parsley-validate="" >
                  <section id="Search" class="LB XXCN  P20">
                     ...
                     <button class="RB Xbutton" style="background: #e12236"; id="searchBtn" ng-click="homesearch()">Search Buses</button>
                  </section>
				  </form>
               </div>
               <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="wrapper">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                           <div class="tb_operator">
                              <img src="<?php echo base_url();?>assets/images/routte.png"> &nbsp;<span class="tb_operator1">50 <small class="smalls">ROUTES</small></span>
                           </div>
                        </div>
                        <div class="col-md-4  col-sm-12 col-xs-12">
                           <div class="tb_operator left"> 
                              <img src="<?php echo base_url();?>assets/images/route.png">  &nbsp;<span class="tb_operator2">100<small class="smalls"> BUS OPERATORS</small></span>
                           </div>
                        </div>
                        <div class="col-md-4  col-sm-12 col-xs-12">
                           <div class="tb_operator right"> 
                              <img src="<?php echo base_url();?>assets/images/ticket.png">  &nbsp;<span class="tb_operator3">100,000 + <small class="smalls">TICKETS SOLD</small></span>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="wrapper">
                           <div class="col-md-4">
                              <div class="tb_offers1">
                                 ...
                                 <div class="tb_list_offer">
                                    <div class="ofer_list">UPTO #1000 OFF</div>
                           ...
                           <div class="col-md-4">
                              <div class="tb_offers1_top">
                                 ...
                                 <div class="tb_list_offer" style=" border-right: 1px solid #dddddd;">
                                    ...
                                    <div class="ofer_list_bold">ON HOTELS ACROSS NIGERIA</div>
                           ...
                           <div class="col-md-4">
                              <div class="tb_offers3">
                                 ...
                                 <div class="tb_list_offer">
                                    <div class="ofer_list"> &nbsp;&nbsp;FLAT #1000 OFF</div>
