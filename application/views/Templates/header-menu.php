               ...
               <div class="col-md-4" style="padding:0;">
                  <div class="tb_navbar">
                     <ul>
                        ...
                        <li><a href="<?php echo base_url();?>printsms">Print/SMS Ticket &nbsp;  <span style="color:#f0a2a3;"> |</span></a></li>
                        <li><a href="<?php echo base_url();?>cancellation">Easy Cancel/Refund</a> </li>
                     </ul>
                  </div>
               </div>
...
<button onclick="myFunction()" class="dropbtn">WELCOME <?php echo $user['username'];?>  &nbsp; <i class="fa fa-user"></i></button>        
