                                    ...
                                    <div class="login-block width top">
                                       <div id="myCarousel{{$index}}" class="carousel slide" data-ride="carousel">
                                          ...
                                          <div class="carousel-inner" role="listbox">
                                             <div class="item " ng-repeat="busimage in details.gallery  track by $index" ng-class="{active:$first}">
                                       ...
                                       <table class="cancel_table">
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td ng-show="details.type =='percentage'">#. {{details.percentage}}</td>
												<td ng-show="details.type =='flat'" >#. {{details.flat}}</td>
                                             </tr>
                                             <tr>
 ...
 <div class="modal fade" id="myModalrate{{$index}}" role="dialog">
					...
					boundary-links="true" >
                     ...
                     <div class="tb_seats_list5">
                        <div class="tb_seats_list1_inner">
                           <p style="font-weight:600;font-size:15px;"># {{details.fare}}</p>
						   <?php 
         ...
         <div class="seat_arragement seat_view" id="bus{{details.bus_id}}">
            <div class="seat_arragement_outer">
               ...
               <div class="order_contact_inf">Base Fare:  <span class="tb_fare rate_bus">  # </span>   </div>
               </li>
               <li>
               <div class="order_cnct_detail"><img src="<?php echo base_url();?>assets/images/booked.png">  Booked  </div>
               <div class="order_contact_inf">  Total Fare   <span class="tb_fare total_rate">  #{{details.fare}}</span>  </div>
               </li>
               </ul>
               </div>
               </div>
			   ...
			   <option ng-if="isArray(details.Dpoints)" ng-repeat="Dpoints in details.Dpoints" value="{{Dpoints.board_id}}"></option>


               <option ng-if="!isArray(details.Dpoints)" value="{{details.Dpoints.board_id}}">{{details.Dpoints.dplace}}</option>
